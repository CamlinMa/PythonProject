...
class KMeansClustering:
    def __init__(self, file_name, k, description, weight, pca, components, initialCentroids, num):
        ...
        graph = Graph(pointset, file_name, column_index)  # 绘图
        image_path = graph.path  # 图片相对路径
    ...
    def create_html(self, info_A, info_B, info_C, file_name, image_path):
        ...
        print('生成分析报告 成功')
        path_h= get_rusult_path() + file_name + '.html'
        webbrowser.open(path_h, new=1, autoraise=True)
